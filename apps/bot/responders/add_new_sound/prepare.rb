    ...
    module AddNewSound
      class Prepare
        ...
        def respond!
          ...
          when :content
            "Good, now, please, send me a *voice message* or an *.ogg*, *.mp3* or *.wav* file. Please note, that the file will be cut to the first #{ Settings::MAX_SOUND_DURATION } seconds."
          when :tags
